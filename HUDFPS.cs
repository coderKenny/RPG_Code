...
public class HUDFPS : MonoBehaviour
{
    ...
    public Rect targetRect; // Target rect

    public bool updateColor = true; // Do you want the color to change if the FPS gets low
    public bool allowDrag = true; // Do you want to allow the dragging of the FPS window
    public float frequency = 0.5F; // The update frequency of the fps
    private int nbDecimal = 3; // How many decimal do you want to display
    ...
    //private Button namiska = new Button();
    ...
    void Start()
    {
        ...
        startRect = new Rect(10, 10, currentWidth, currentHeight); // The rect the window is initially displayed at
    ...
    void OnGUI()
    {
        ...
        // Register the window
        startRect = GUI.Window(2, startRect, DoMyWindow, "Counting FPS");
    }
    ...
    void DoMyWindow(int windowID)
    {
        ...
        if (allowDrag)
        {
            ...
            if (GUI.Button(new Rect(10, startRect.height - 30, 120, 20), "Change accuracy !"))
            {       
                toggler = !toggler;
                Debug.Log("Painettu !!!");
